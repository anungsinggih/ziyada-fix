-- ============================================================
-- 0006_dashboard_finance_health.sql
-- Add Finance Health (AR/AP/Cash) to Dashboard RPC
-- ============================================================
...
begin
  ...
  -- Cash Balance (Simple Snapshot of Ledger for account 1100)
  -- Note: Ideally this should reuse a shared logic, but for dashboard speed we query journal directly
