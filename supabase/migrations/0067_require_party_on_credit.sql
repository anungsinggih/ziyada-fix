-- ============================================================
-- 0067_require_party_on_credit.sql
-- Require customer/vendor for credit terms
-- ============================================================
...
begin
  ...
  if v_sales.terms <> 'CASH' and v_sales.customer_id is null then
    raise exception 'Customer is required for credit terms';
  end if;
...
begin
  ...
  if v_purchase.terms <> 'CASH' and v_purchase.vendor_id is null then
    raise exception 'Vendor is required for credit terms';
  end if;
