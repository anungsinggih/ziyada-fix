-- ============================================================
-- 0086_import_master_data_overwrite.sql
-- Overwrite existing SKU with imported data (with cost rules)
-- ============================================================
    ...
    loop
        ...
        if v_existing_item_id is not null then
            ...
            set name = v_item_name,
                type = v_item_type::item_type,
                uom_id = v_uom_id,
                size_id = v_size_id,
                color_id = v_color_id,
                price_default = v_price_default,
                price_khusus = v_price_khusus,
                default_price_buy = v_def_price_buy,
