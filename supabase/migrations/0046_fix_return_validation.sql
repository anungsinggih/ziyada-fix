-- ============================================================
-- 0046_fix_return_validation.sql
-- Validate return qty vs original docs and fix sales return COGS join
-- ============================================================

-- SALES RETURN: prevent over-return and use weighted cost per item
...
-- PURCHASE RETURN: prevent over-return (qty vs purchased - already returned)
