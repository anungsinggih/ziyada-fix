-- ============================================================
-- 0077_guard_adjustment_cost.sql
-- Prevent blank journals by requiring cost for stock adjustment
-- ============================================================
...
begin
  ...
  if v_journal_amount <= 0 then
    raise exception 'Cost is zero; set purchase price or avg cost before adjustment';
  end if;
