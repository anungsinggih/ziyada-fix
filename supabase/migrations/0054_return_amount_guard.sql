-- ============================================================
-- 0054_return_amount_guard.sql
-- Guard return total not exceeding original document remaining
-- ============================================================
...
begin
  ...
  select coalesce(sum(qty * unit_price),0) into v_sales_total
  from public.sales_items
...
begin
  ...
  select coalesce(sum(qty * unit_cost),0) into v_pur_total
  from public.purchase_items
