-- ============================================================
-- 0047_fix_post_totals_recompute.sql
-- Recompute line subtotals server-side on posting
-- ============================================================

-- POST SALES: recompute items subtotal from qty * unit_price
...
-- POST PURCHASE: recompute items subtotal from qty * unit_cost
